    ...
    <section className="relative py-20 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-14">
        ...
        >
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-red-200">Phone</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-red-200">Address</p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-10 rounded-2xl shadow-2xl">
            ...
            <form className="space-y-5">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 rounded-lg bg-white/20 text-white border border-white/20 focus:outline-none focus:ring-2 focus:ring-red-300"
